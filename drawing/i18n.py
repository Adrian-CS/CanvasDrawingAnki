...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "check_field_hint": (
            ...
            "direction. A field holding a word gets one canvas per kanji in it. "
    ...
    "es": {
        ...
        "check_field_hint": (
            ...
            "por cada kanji. Se aplica a las plantillas que añadas a partir de ahora."
        ),
    ...
    "ja": {
        ...
        "check_field_hint": (
            ...
            "手本の形・筆順・方向と照合します。単語が入っている場合は漢字ごとに1つ"
